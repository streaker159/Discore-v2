...
async function buildEventsEmbed(interaction) {
  return createDiscoreEmbed(interaction, {
    ...
    description: [
      ...
      "• Uses DeepSeek AI, 1 credit per question",
    ].join("\n"),
  });
}
...
async function buildPremiumEmbed(interaction) {
  return createDiscoreEmbed(interaction, {
    ...
    description: [
      ...
      "",
      "### 💳 Premium Management",
      "`/premium` — View status & AI credit balance, then use the buttons to:",
      "• Upgrade / Manage Premium",
      "• Buy AI Credits",
      "• Refresh Status",
      "• AI Usage Limits & Feature Toggles",
      "",
      ...
      "• AI still works if you buy AI credits",
      "",
