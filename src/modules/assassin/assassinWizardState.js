...
/**
 * Lightweight TTL-based in-memory state store for Assassin setup wizard sessions.
 *
 ...
 *
 * Pattern: identical to the project's sniper, event, and suggestion wizard state stores.
 */
