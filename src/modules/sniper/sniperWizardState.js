...
/**
 * Lightweight TTL-based in-memory state store for Sniper Challenge setup wizard sessions.
 *
 * Stores only primitive data — no Discord objects, no circular references.
 * Entries auto-expire after TTL_MS (30 minutes by default).
 * Garbage-collected every CLEANUP_INTERVAL_MS.
 *
 * Pattern: identical to the project's event and suggestion wizard state stores.
 */
